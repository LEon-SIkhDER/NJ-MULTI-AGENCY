...
const EditModerator = ({ children, className, moderator, refetch }: Props) => {
    const modalRef = useRef<HTMLDialogElement | null>(null);
    const formRef = useRef<HTMLFormElement | null>(null);
    const photoInputRef = useRef<HTMLInputElement | null>(null);
    const photoInputId = useId();

    const [photoPreview, setPhotoPreview] = useState<string | null>(moderator.image?.photoUrl || null);
    const [imageError, setImageError] = useState(false);
    const [sameAddress, setSameAddress] = useState(false);

    const defaultJoinedAt = moderator.joinedAt
        ? new Date(moderator.joinedAt).toISOString().split("T")[0]
        : "";

    const handleOpenModal = () => {
        setImageError(false);
        setPhotoPreview(moderator.image?.photoUrl || null);
    ...
    const handleEditModerator = async (e: SyntheticEvent<HTMLFormElement>) => {
        e.preventDefault();
        ...
        let toastId = toast.loading("Updating Moderator...");
        ...
        try {
            ...
            toast.dismiss(toastId);
            toast.error(err.message || "Failed to update moderator");
        }
    };

    const firstLetter = (moderator.name || "M").trim().charAt(0).toUpperCase();
            ...
            {typeof document !== "undefined" && createPortal(
                <dialog ref={modalRef} className="modal">
                        ...
                        <div className="flex items-center justify-between px-4 sm:px-6 pt-5 sm:pt-6 pb-4 sm:pb-5 border-b border-border/80">
                            <div>
                                ...
                                <p className="text-xs mt-0.5 text-text-muted">
                                    Update details and authority for {moderator.name}.
                                </p>
                            </div>
                            <button
                                type="button"
                    ...
                    <div className="overflow-y-auto px-6 py-6 max-h-[75vh]">
                        <form onSubmit={handleEditModerator} ref={formRef}>
                            {/* Profile Picture */}
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-3">
                                ...
                                <div className="flex flex-col gap-1.5">
                                    ...
                                    <select
                                        ...
                                        name="gender"
                                        defaultValue={moderator.gender || "male"}
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-3">
                                <div className="flex flex-col gap-1.5">
                                    ...
                                    <select
                                        ...
                                        defaultValue={moderator.maxQualification || ""}
                                        className="select w-full bg-surface-2 border border-border rounded-xl text-text text-sm focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all"
                                    >
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-3">
                                <Field
                                    ...
                                    type="number"
                                    placeholder="e.g. 3"
                                    defaultValue={moderator.experienceYears || ""}
                                ...
                                <Field
                                    ...
                                    type="text"
                                    placeholder="e.g. Platform Guardian & Operations"
                                    defaultValue={moderator.specialization || ""}
                                    icon={<Briefcase size={15} />}
                                />
                            </div>
                            <div className="mt-4">
                                ...
                                <div className="relative mt-1.5">
                                    ...
                                    <textarea
                                        ...
                                        name="bio"
                                        rows={3}
                                        defaultValue={moderator.bio || ""}
                                        placeholder="A brief description about the moderator"
                                ...
                                <div className="flex flex-col gap-1.5">
                                    ...
                                    <div className="relative">
                                        ...
                                        <textarea
                                            ...
                                            name="presentAddress"
                                            rows={2}
                                            defaultValue={moderator.presentAddress || ""}
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        ...
                                        <div className="relative">
                                            ...
                                            <textarea
                                                ...
                                                rows={2}
                                                defaultValue={moderator.permanentAddress || ""}
                                                placeholder="House, Road, Area, City"
                                                className="w-full pl-9 pr-3.5 py-2.5 bg-surface-2 border border-border rounded-xl text-sm text-text placeholder:text-text-faint focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all resize-y"
                                            />
                                        </div>
